  ...
  return (
    <>
      <header
        ...
        className="relative z-[99] border-b-[1px]  border-primary/50 bg-gradient-to-l from-yellow-400 via-yellow-400 to-yellow-400 text-black shadow-lg"
      >
        <nav className="container  flex h-[70px] items-center justify-between py-2 ">
          <div className="text-2xl text-black md:text-3xl ">
            <a href="/#home" className="">
              APP
              <span className="inline-block font-bold text-primary">WORLD</span>
            </a>
          </div>
          {/* Desktop Menu */}
              ...
              <li className="group relative cursor-pointer">
                ...
                <div className="absolute -left-9 z-[9999] hidden w-[150px] rounded-md bg-white p-2 text-black group-hover:block  ">
                  <ul className="space-y-3">
                    <li className="p-2 hover:bg-blue-300">Services</li>
                    <li className="p-2 hover:bg-blue-300">About us</li>
                    <li className="p-2 hover:bg-blue-300">Privacy policy</li>
                  </ul>
                </div>
              </li>
