...
const Hero = () => {
  return (
    <main className="bg-gradient-to-r from-yellow-300 to-yellow-300 pt-20 dark:bg-yellow-300">
        ...
        <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
          ...
          >
            ...
            <div className="space-x-4">
              <button className="rounded-md border-2 border-primary bg-primary px-4 py-2 text-sm text-black transition-colors duration-300 hover:bg-primary/80">
                Get Started
              </button>
            </div>
          </div>
